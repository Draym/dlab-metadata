...
import {GetRequest as MetadataGetRequest} from "../api/dtos/collection/metadata"
...
router.get(Endpoint.COLLECTION_METADATA_Get, validatePathRequest(MetadataGetRequest), handle.bind(ctrl.metadataGet))
